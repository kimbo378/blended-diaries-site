      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <Link href="/" className="flex items-center space-x-2 group">
            <h1 className="font-handwritten text-2xl sm:text-3xl text-diary-charcoal group-hover:text-diary-red transition-colors">
              The Blended Diaries
            </h1>
            <Heart className="text-diary-red text-lg" fill="currentColor" />
          </Link>
