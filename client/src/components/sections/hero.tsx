    ...
    <section className="relative py-12 sm:py-20 margin-line">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-handwritten text-4xl sm:text-6xl lg:text-7xl text-diary-charcoal/80 font-light mb-4">
            Chaos. Love. Repeat.
          </h2>
        ...
        <div className="md:col-span-2 flex flex-col justify-center space-y-6">
          <p className="font-handwritten text-2xl sm:text-3xl text-diary-purple">
            "A diary series that makes blended family chaos feel normal. You
            will laugh. You might cry. You will definitely nod."
          </p>
        </div>
